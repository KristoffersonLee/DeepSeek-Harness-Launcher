...
tools/check-consistency.ps1             一致性校验（177 项，含行为性硬约束）
...
```powershell
pwsh -NoProfile -File tools\check-consistency.ps1      # 177 source/config invariants
